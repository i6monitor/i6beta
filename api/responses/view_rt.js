 ...
 *     return res.view_rt();
 *     // -or-
 *     return res.view_rt(optionalData);
 * ```
 *
 * Or with actions2:
 * ```
...
module.exports = function view_rt(optionalData) {
  ...
  if (optionalData === undefined) {
    sails.log.info('Ran custom response: res.view_rt()');
  ...
  // except in production use res.sendStatus().
    ...
    sails.log.info('Custom response `res.view_rt()` called with an Error:', optionalData);
